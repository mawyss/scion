...
func (x *DigestExtension_Digest) Reset() {
	*x = DigestExtension_Digest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_control_plane_v1_seg_extensions_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_proto_control_plane_v1_seg_extensions_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x2e, 0x76, 0x31, 0x22, 0xf7, 0x01, 0x0a, 0x15, 0x50, 0x61, 0x74, 0x68, 0x53, 0x65,
	...
	,
	...
	0x5f, 0x4f, 0x50, 0x45, 0x4e, 0x5f, 0x4e, 0x45, 0x54, 0x10, 0x03, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
var file_proto_control_plane_v1_seg_extensions_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_proto_control_plane_v1_seg_extensions_proto_goTypes = []interface{}{
	...
	nil,                            // 10: proto.control_plane.v1.StaticInfoExtension.InternalHopsEntry
	nil,                            // 11: proto.control_plane.v1.LatencyInfo.IntraEntry
	nil,                            // 12: proto.control_plane.v1.LatencyInfo.InterEntry
	nil,                            // 13: proto.control_plane.v1.BandwidthInfo.IntraEntry
	nil,                            // 14: proto.control_plane.v1.BandwidthInfo.InterEntry
	(*DigestExtension_Digest)(nil), // 15: proto.control_plane.v1.DigestExtension.Digest
}
var file_proto_control_plane_v1_seg_extensions_proto_depIdxs = []int32{
	...
	8,  // 5: proto.control_plane.v1.StaticInfoExtension.geo:type_name -> proto.control_plane.v1.StaticInfoExtension.GeoEntry
	9,  // 6: proto.control_plane.v1.StaticInfoExtension.link_type:type_name -> proto.control_plane.v1.StaticInfoExtension.LinkTypeEntry
	10, // 7: proto.control_plane.v1.StaticInfoExtension.internal_hops:type_name -> proto.control_plane.v1.StaticInfoExtension.InternalHopsEntry
	11, // 8: proto.control_plane.v1.LatencyInfo.intra:type_name -> proto.control_plane.v1.LatencyInfo.IntraEntry
	12, // 9: proto.control_plane.v1.LatencyInfo.inter:type_name -> proto.control_plane.v1.LatencyInfo.InterEntry
	13, // 10: proto.control_plane.v1.BandwidthInfo.intra:type_name -> proto.control_plane.v1.BandwidthInfo.IntraEntry
	14, // 11: proto.control_plane.v1.BandwidthInfo.inter:type_name -> proto.control_plane.v1.BandwidthInfo.InterEntry
	15, // 12: proto.control_plane.v1.DigestExtension.epic:type_name -> proto.control_plane.v1.DigestExtension.Digest
	6,  // 13: proto.control_plane.v1.StaticInfoExtension.GeoEntry.value:type_name -> proto.control_plane.v1.GeoCoordinates
	0,  // 14: proto.control_plane.v1.StaticInfoExtension.LinkTypeEntry.value:type_name -> proto.control_plane.v1.LinkType
...
func file_proto_control_plane_v1_seg_extensions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_control_plane_v1_seg_extensions_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
